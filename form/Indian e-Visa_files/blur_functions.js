...
function load_additional_questions() {
    $('.answers').each(function (i, obj) {
        $($(this)).blur(function () {
            var res = validate_generic_data($(this).val(), 1, 200);
            if (res != "true")
            {
                errorifyQuestion($(this), res);
            } else {
                correctifyQuestion($(this), "");
            }
        });
    });
}//end of load_additional_questions
