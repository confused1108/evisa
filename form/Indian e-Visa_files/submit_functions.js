function correctUrl(url) {
    ...
    var b = url.toString().replace(protomatch, '');
    protomatch = /^(HTTPS?|FTP):\/\//;
    b = url.toString().replace(protomatch, '');
    return b;
}
...
function validate_visa_details_temp_exit(visa_type) {
    ...
    var submit = true;
    var result = "";
    var res = validate_places_to_be_visited($('#placesToBeVisited1_id').val(), "1");
    if (res != "true")
    {
        submit = false;
        errorify($('#placesToBeVisited1_id'), res);
    } else {
        correctify($('#placesToBeVisited1_id'), "");
    }

    res = validate_places_to_be_visited($('#placesToBeVisited2_id').val(), "0");
    if (res != "true")
    {
        submit = false;
        errorify($('#placesToBeVisited1_id'), res);
    ...
    if (document.getElementById('haveYouBookedRoomInHotel_yes_id') != undefined) {
        if (document.getElementById('haveYouBookedRoomInHotel_yes_id').checked == false && document.getElementById('haveYouBookedRoomInHotel_no_id').checked == false) {
            errorify($('#haveYouBookedRoomInHotel_yes_id'), "Please select yes or no");
            submit = false;
        } else {
            correctify($('#haveYouBookedRoomInHotel_yes_id'), "");
            correctify($('#haveYouBookedRoomInHotel_yes_id'), "");
        }
    }

    if (document.getElementById('haveYouBookedRoomInHotel_yes_id').checked == true) {
        res = validate_generic_data($('#nameTourOperator_id').val(), 1, 50);
        if (res != "true")
        {
            submit = false;
            errorify($('#nameTourOperator_id'), res);
        } else {
            correctify($('#nameTourOperator_id'), "");
        }

        res = validate_generic_address($('#addressTourOperator_id').val(), 1, 50);
        if (res != "true")
        {
            submit = false;
            errorify($('#addressTourOperator_id'), res);
        } else {
            correctify($('#addressTourOperator_id'), "");
        }
        res = validate_generic_data($('#nameOfHotelResort_id').val(), 1, 50);
        if (res != "true")
        {
            submit = false;
            errorify($('#nameOfHotelResort_id'), res);
        } else {
            correctify($('#nameOfHotelResort_id'), "");
        }
        res = validate_generic_data($('#placeOfHotelResort_id').val(), 1, 50);
        if (res != "true")
        {
            submit = false;
            errorify($('#placeOfHotelResort_id'), res);
        } else {
            correctify($('#placeOfHotelResort_id'), "");
        }
    ...
    $('.service_req_form_val').each(function (i, obj) {
        ...
        if (label == "Details of the Friend/Relative") {
        ...
        //purpose code of for eConference visa 33
        else if (label == "Name/subject of the conference") {
            var res = validate_generic_data($(this).val(), 1, 50);
            if (res != "true")
            {
                submit = false;
            ...
            var res = validate_conferencedate($(this).val(), 1, 3);
            if (res != "true")
            {
                submit = false;
                errorify($(this), res);
            ...
            var res = validate_pincode($(this).val(), 1);
            if (res != "true")
            {
                submit = false;
                errorify($(this), res);
        ...
        } else if (label == "Name of organizer") {
            var res = validate_generic_data($(this).val(), 1, 50);
            if (res != "true")
            {
                submit = false;
            ...
            console.log("email id is " + $(this).val());
            var res = validate_email($(this).val(), 1, 3);
            if (res != "true")
            {
                submit = false;
                errorify($(this), res);
        ...
        // end purpose code of for eConference visa 35
        else if (label == "Name of the principal e-Medical Visa holder (i.e. the patient)") {
        ...
        } else if (label == "Visa number of principal e-Medical Visa holder") {
            var res = validate_generic_alpha_num($(this).val(), 0, 10);
            if (res != "true")
            {
                submit = false;
                errorify($(this), res);
        ...
        } else if (label == "Application id of principal e-Medical Visa holder") {
            var res = validate_filenumber($(this).val(), 0);
            if (res != "true")
            {
                submit = false;
                errorify($(this), res);
        ...
        } else if (label == "Visa No. / Application id of principal e-Medical Visa holder") {
            var res = validate_generic_data($(this).val(), 1, 50);
            if (res != "true")
            {
                submit = false;
                ...
                correctify($(this), "");
                if ($('#patient_visa_no').val().trim() === '' && $('#patient_application_id').val().trim() === '') {
                    submit = false;
                    errorify($(this), 'Atleast one of visa no or application id is mandatory');
                }
            }
        } else if (label == "Passport number of principal e-Medical Visa holder") {
            var res = validate_passportNo($(this).val(), 1);
            if (res != "true")
            {
                submit = false;
                errorify($(this), res);
        ...
        } else if (label == "Date of birth of principal e-Medical Visa holder") {
            var res = validate_dob($(this).val(), 1);
            if (res != "true")
            {
                submit = false;
                errorify($(this), res);
        ...
        } else if (label == "Nationality of principal e-Medical Visa holder") {
            var res = validate_Nationality($(this).val(), 1);
            if (res != "true")
            {
                submit = false;
                errorify($(this), res);
    ...
    if (document.getElementById('country_visited') != undefined) {
        var options = $('#country_visited > option:selected');
        if (options.length > 20) {
            errorify($('#country_visited'), "Maximum 20 countries can be selected");
            submit = false;
        } else {
            correctify2($('#country_visited'), "");
        }
...
function  validate_visa_details_continue_form(visa_type) {
    ...
    if (document.getElementById('haveYouBookedRoomInHotel_yes_id').checked == true) {
        var res = validate_generic_data($('#nameTourOperator_id').val(), 1, 50);
        if (res != "true")
        {
            submit = false;
            errorify($('#nameTourOperator_id'), res);
    ...
    $('.service_req_form_val').each(function (i, obj) {
        ...
        //purpose code of for eConference visa 33
            ...
            var res = validate_email($(this).val(), 1);
            if (res != "true")
            {
                submit = false;
                errorify($(this), res);
        ...
        //purpose code of for eMedical attendant visa 35 start
        else if (label == "Name of the principal e-Medical Visa holder (i.e. the patient)") {
            var res = validate_generic_alpha_sp($(this).val(), 1, 50);
            if (res != "true")
            {
        ...
        //purpose code of for eMedical attendant visa 35 END
    });
...
function validate_reprint_form() {
    ...
    if (submit) {
        ...
        $('#reprint_btn').prop('disabled', true);
    }
    //alert(submit);
    return submit;
...
function validate_additional_questions() {
    var submit = true;
    var result = "";
    for (var i = 1; i < 7; i++)
    {
        if (document.getElementById('question_yes_' + i) != undefined) {
            if (document.getElementById('question_yes_' + i).checked == false && document.getElementById('question_no_' + i).checked == false) {
                errorifyRadio($('#question_yes_' + i), "Please select yes or no");
                submit = false;
                return submit;
            } else {
                correctifyRadio($('#question_yes_' + i), "");
                correctifyRadio($('#question_no_' + i), "");
            }
            //if yes then check if answer is written or not
            if (document.getElementById('question_yes_' + i).checked == true) {
                //validate answer corresponding to i
                var answerValue = "";
                if ($('#answer_' + i).val() !== undefined) {
                    answerValue = $('#answer_' + i).val();
                }
                var res = validate_generic_data(answerValue, 1, 200);
                if (res != "true")
                {
                    $('#answer_' + i).css('display', '');
                    errorifyQuestion($('#answer_' + i), res);
                    submit = false;
                    return submit;

                } else {
                    $('#answer_' + i).css('display', '');
                    correctifyQuestion($('#answer_' + i), "");
                }
            }

        }
    }
    if (document.getElementById("verifyQuestions").checked == false) {
        document.getElementById("verifyQuestions").focus();
        alert("Please click the checkbox to continue.");
        return false;
    }
...
function validate_feedback_form() {
    var submit = true;
    //var rating_val = $('input[name=rating]:checked').val();
    var rating_val = $('#rating').val();
    var res = "";
    if (rating_val === "" || parseInt(rating_val) === 0 || rating_val === "0") {
        $('#errorMessage').html("Please provide rating by clicking on stars.");
        return false;
    } else {
        $('#errorMessage').html('');
    }
    //errorMessage
    if (rating_val <= 3) {
        res = validate_feedback_comments($('#description').val(), 1, 200);
    } else {
        res = validate_feedback_comments($('#description').val(), 0, 200);
    }
    if (res != "true")
    {
        submit = false;
